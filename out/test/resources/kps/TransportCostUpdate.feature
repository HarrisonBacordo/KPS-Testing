Feature: Updating the cost of transporting a parcel
  ...
  Scenario Outline:
    ...
    And there is a transport cost update
    ...
    Examples:
      ...
      | 1      | 1000         | Dunedin          | New Zealand  | Christchurch     | New Zealand | domestic standard | Fake Trucks   | Land  |